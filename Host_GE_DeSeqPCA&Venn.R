...
###host data
setwd("~/Desktop/~directory path~/Host_GE")
...
#read in counts
countData <- read.table("~/Desktop/~file path~/Ofav_counts_fixedSNP.txt")
head(countData)
...
#read in counts
countData <- read.table("~/Desktop/~file path~/Ofav_countsfixed_fixedSNP_noClones.txt")
head(countData)
...
#import metadata
rt <- read.csv("~/Desktop/~file path~/Thermvar_metadata_Apr2025_ClonesFixed.csv")
