# DTV Coral Thermal Priming Analysis
...
Additional physiological and gene expression measures were only sampled after thermal priming (12 days acclimation and 90 days priming) and at the end of the subsequent heat challenge experiment. These included measures of photosynthesis and dark respiration rates, DNA for ITS2 and 16S characterization, and RNA for transcriptomic analysis. Genotype was controlled across treatments and measures. 
...
| Description | File |
|---|---|
| R code for 16S analysis | *(TBD)* |
| 16S taxonomy identification | *(TBD)* |
| 16S ASV counts | *(TBD)* |
